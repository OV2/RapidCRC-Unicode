...
TCHAR *g_hash_names[] = { TEXT("CRC"), TEXT("MD5"), TEXT("ED2K"), TEXT("SHA1"), TEXT("SHA256"), TEXT("SHA512"), TEXT("SHA3-224"), TEXT("SHA3-256"), TEXT("SHA3-512"), TEXT("CRC32C"), TEXT("BLAKE2SP"), TEXT("BLAKE3") };
